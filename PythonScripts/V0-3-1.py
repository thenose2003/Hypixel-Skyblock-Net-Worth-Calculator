...
#Notes to user
    print('Thank you for using the "Hypixel Skyblock NetWorth Calculator" created by The_Nose_!')
    print('If you do like this program please be sure to show your support by sharing this')
    print('project! For this calculator to work most effectively make sure you have any items')
    print('of value in a place accessible by your API settings. The program only')
    print('accesses your purse, so be sure to keep that in mind. All prices are taken')
    print('from the public GitHub repo for Jerry Bot by SkyBlockZ. Be sure to join their')
    print('discord at discord.gg/skyblock All items the program does not recognize will be')
    print('stated so you can take those into account after the fact. Remember this program')
    print('is still in a very early stage and I need all the feedback I can get. If there')
    print('are any items that are not being taken into account please tell me. You can contact')
    print('me through the discord at https://discord.gg/sXMwhJH or on the GitHub repo.')
    print('')
        ...
        if x != -1:
            ...
            if (itemname == 'GREATER_BACKPACK') or (itemname == 'LARGE_BACKPACK') or (itemname == 'MEDIUM_BACKPACK') or (itemname == 'SMALL_BACKPACK'):
                try:
                    ...
                    net_netcalc(n)
                except: #Incase backpack has never been opened
                    pass
...
def net_Worth(**kwargs):
    ...
    net_slayer(profile['profile']['members'][uuid]['slayer_bosses'])
        ...
        #Minions
    if kwargs.get('minions', None) != False:
